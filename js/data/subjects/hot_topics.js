...
// Generated by dev/build_hot_topics.py from doc_2 §III, then hand-augmented:
// each controversy card carries a "Note:" citing the relevant PCA General
// Assembly action (study/ad-interim committee report, pastoral letter, or BCO
// provision), verified by GA number, year, and title. If the builder is re-run,
// port these GA notes into its CURATE layer (the source_materials inputs must be
// restored from git history first).
...
(function (global) {
  ...
  const SUBJECT = {"id":"hot_topics","label":"Hot Topics","blurb":"Contemporary controversies: creation, gifts, the Sabbath, women, theonomy, and more.","order":6,"setKeys":["ht-topics","ht-reference"]};
